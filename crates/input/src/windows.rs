use windows::Win32::UI::Input::KeyboardAndMouse::{
    ...
    VK_C, VK_CONTROL, VK_D, VK_DOWN, VK_E, VK_ESCAPE, VK_F, VK_G, VK_H, VK_I, VK_J, VK_K, VK_L,
    VK_LEFT, VK_LWIN, VK_M, VK_MENU, VK_N, VK_O, VK_P, VK_Q, VK_R, VK_RETURN, VK_RIGHT, VK_RWIN,
